...
Replacer.create().replace<IIngredient>(<recipecomponent:farmersdelight:recipe_component/cutting_board_tool>, <tag:items:c:tools/knife>, <tag:items:c:tools/axe>).execute();
