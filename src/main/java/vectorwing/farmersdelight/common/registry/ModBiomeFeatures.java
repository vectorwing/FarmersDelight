...
public class ModBiomeFeatures
{
	...
	public static final Supplier<Feature<NoneFeatureConfiguration>> WILD_RICE = FEATURES.register("wild_rice", () -> new WildRiceFeature(NoneFeatureConfiguration.CODEC));
