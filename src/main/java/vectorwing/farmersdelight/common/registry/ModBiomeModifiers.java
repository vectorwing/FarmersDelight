...
public class ModBiomeModifiers
{
	...
	public static void bootstrap(BootstapContext<BiomeModifier> context) {
		...
		context.register(WILD_RICE, new AddFeaturesByFilterBiomeModifier(biomeGetter.getOrThrow(Tags.Biomes.IS_HOT_OVERWORLD), Optional.of(biomeGetter.getOrThrow(Tags.Biomes.IS_WET)), Optional.empty(), Optional.empty(), HolderSet.direct(featureGetter.getOrThrow(WildCropGeneration.PLACED_WILD_TOMATOES)), GenerationStep.Decoration.VEGETAL_DECORATION));
	}
}
