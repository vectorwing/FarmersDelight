...
public class ModBiomeModifiers
{
	...
	public static void bootstrapBiomeModifiers(BootstrapContext<BiomeModifier> ctx) {
		...
		ctx.register(WILD_CABBAGES, createSimpleModifier(
				biomeGetter.getOrThrow(Biomes.BEACH), 
				placedFeatureGetter.getOrThrow(WildCropGeneration.PATCH_WILD_CABBAGES)
		));
		...
		ctx.register(WILD_BEETROOTS, createSimpleModifier(
				biomeGetter.getOrThrow(Biomes.BEACH),
				placedFeatureGetter.getOrThrow(WildCropGeneration.PATCH_WILD_BEETROOTS)
		));
