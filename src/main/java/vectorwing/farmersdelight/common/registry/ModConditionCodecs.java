...
public class ModConditionCodecs
{
	...
	public static final Supplier<MapCodec<? extends ICondition>> VALIDATE_FLUID_TAG = CONDITION_CODECS.register("validate_fluid_tag", () -> ValidateFluidTagCondition.CODEC);
}
