...
// TODO: Mooooom, the world gen class is broken again!
public class WildCropGeneration
{
	public static ResourceKey<ConfiguredFeature<?, ?>> FEATURE_PATCH_SANDY_SHRUB_BONEMEAL = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(FarmersDelight.MODID, "patch_sandy_shrub"));
...
//		return BuiltinRegistries.register(Registries.PLACED_FEATURE, id, new PlacedFeature(Holder.hackyErase(feature), List.of(modifiers)));
//	}
//
...
//		return register(BuiltnRegistries.CONFIGURED_FEATURE, id, new ConfiguredFeature<>(feature, featureConfig));
//	}
//
