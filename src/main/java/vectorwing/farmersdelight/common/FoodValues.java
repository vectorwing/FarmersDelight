...
public class FoodValues
{
	...
	public static class ConsumableValues {
		...
		public static final Consumable HOT_COCOA = Consumables.DEFAULT_DRINK;
		public static final Consumable MILK_BOTTLE = Consumables.DEFAULT_DRINK;
		public static final Consumable MELON_JUICE = Consumables.DEFAULT_DRINK;
		public static final Consumable MELON_POPSICLE = Consumables.defaultFood().consumeSeconds(0.8F).build();
