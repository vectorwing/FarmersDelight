...
public class DataMaps extends DataMapProvider
{
	...
	protected void gather(HolderLookup.@NotNull Provider provider) {
		builder(NeoForgeDataMaps.FURNACE_FUELS)
			.add(ModItems.STRAW.get().asItem().builtInRegistryHolder(), new FurnaceFuel(100), false)
			.add(ModItems.CANVAS.get().asItem().builtInRegistryHolder(), new FurnaceFuel(400), false)
			.add(ModItems.TREE_BARK.get().asItem().builtInRegistryHolder(), new FurnaceFuel(200), false);
