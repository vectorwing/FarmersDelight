...
public class Recipes extends RecipeProvider
{
	 ...
	 */
	private void recipesVanillaAlternatives(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesCanvasSigns(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesBlocks(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesTools(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesMaterials(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesFoodstuffs(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesFoodBlocks(Consumer<FinishedRecipe> consumer) {
	...
	private void recipesCraftedMeals(Consumer<FinishedRecipe> consumer) {
