...
public class FDRecipeCategories
{
	...
	{
		RecipeBookRegistry.addCategoriesToType(FarmersDelight.RECIPE_TYPE_COOKING, ImmutableList.of(COOKING_SEARCH.get(), COOKING_MEALS.get(), COOKING_DRINKS.get()));
		RecipeBookRegistry.addAggregateCategories(COOKING_SEARCH.get(), ImmutableList.of(COOKING_MEALS.get(), COOKING_DRINKS.get()));
		RecipeBookRegistry.addCategoriesFinder(ModRecipeTypes.COOKING.get(), r ->
		{
