...
public class FDRecipeCategories
{
	...
	public static final EmiRecipeCategory SOAKING = new EmiRecipeCategory(RecipeUtils.FDLocation("soaking"), FDRecipeWorkstations.JUG, simplifiedRenderer(48, 0));

	public static final EmiRecipeCategory FLUID_EMPTYING = new EmiRecipeCategory(RecipeUtils.FDLocation("fluid_emptying"), FDRecipeWorkstations.FLUID_EMPTYING, simplifiedRenderer(64, 0));
	public static final EmiRecipeCategory FLUID_FILLING = new EmiRecipeCategory(RecipeUtils.FDLocation("fluid_filling"), FDRecipeWorkstations.FLUID_FILLING, simplifiedRenderer(80, 0));
