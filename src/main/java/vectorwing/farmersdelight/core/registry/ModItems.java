package vectorwing.farmersdelight.core.registry;
...
public class ModItems
{
	...
	public static final RegistryObject<Item> CABBAGE = ITEMS.register("cabbage",
			() -> new Item(new Item.Properties().food(FoodValues.CABBAGE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato",
			() -> new Item(new Item.Properties().food(FoodValues.TOMATO).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> ONION = ITEMS.register("onion",
			() -> new ItemNameBlockItem(ModBlocks.ONION_CROP.get(), new Item.Properties().food(FoodValues.ONION).tab(FarmersDelight.ITEM_GROUP)));
	...
	public static final RegistryObject<Item> FRIED_EGG = ITEMS.register("fried_egg",
			() -> new Item(new Item.Properties().food(FoodValues.FRIED_EGG).tab(FarmersDelight.ITEM_GROUP)));
	...
	public static final RegistryObject<Item> APPLE_CIDER = ITEMS.register("apple_cider",
			() -> new DrinkItem(new Item.Properties().food(FoodValues.APPLE_CIDER).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true, false));
	...
	public static final RegistryObject<Item> TOMATO_SAUCE = ITEMS.register("tomato_sauce",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.TOMATO_SAUCE).craftRemainder(Items.BOWL).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> WHEAT_DOUGH = ITEMS.register("wheat_dough",
			() -> new Item(new Item.Properties().food(FoodValues.WHEAT_DOUGH).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> RAW_PASTA = ITEMS.register("raw_pasta",
			() -> new Item(new Item.Properties().food(FoodValues.RAW_PASTA).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> PUMPKIN_SLICE = ITEMS.register("pumpkin_slice",
			() -> new Item(new Item.Properties().food(FoodValues.PUMPKIN_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> CABBAGE_LEAF = ITEMS.register("cabbage_leaf",
			() -> new Item(new Item.Properties().food(FoodValues.CABBAGE_LEAF).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> MINCED_BEEF = ITEMS.register("minced_beef",
			() -> new Item(new Item.Properties().food(FoodValues.MINCED_BEEF).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> BEEF_PATTY = ITEMS.register("beef_patty",
			() -> new Item(new Item.Properties().food(FoodValues.BEEF_PATTY).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> CHICKEN_CUTS = ITEMS.register("chicken_cuts",
			() -> new Item(new Item.Properties().food(FoodValues.CHICKEN_CUTS).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COOKED_CHICKEN_CUTS = ITEMS.register("cooked_chicken_cuts",
			() -> new Item(new Item.Properties().food(FoodValues.COOKED_CHICKEN_CUTS).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> BACON = ITEMS.register("bacon",
			() -> new Item(new Item.Properties().food(FoodValues.BACON).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COOKED_BACON = ITEMS.register("cooked_bacon",
			() -> new Item(new Item.Properties().food(FoodValues.COOKED_BACON).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COD_SLICE = ITEMS.register("cod_slice",
			() -> new Item(new Item.Properties().food(FoodValues.COD_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COOKED_COD_SLICE = ITEMS.register("cooked_cod_slice",
			() -> new Item(new Item.Properties().food(FoodValues.COOKED_COD_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> SALMON_SLICE = ITEMS.register("salmon_slice",
			() -> new Item(new Item.Properties().food(FoodValues.SALMON_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COOKED_SALMON_SLICE = ITEMS.register("cooked_salmon_slice",
			() -> new Item(new Item.Properties().food(FoodValues.COOKED_SALMON_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> MUTTON_CHOPS = ITEMS.register("mutton_chops",
			() -> new Item(new Item.Properties().food(FoodValues.MUTTON_CHOP).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> COOKED_MUTTON_CHOPS = ITEMS.register("cooked_mutton_chops",
			() -> new Item(new Item.Properties().food(FoodValues.COOKED_MUTTON_CHOP).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> HAM = ITEMS.register("ham",
			() -> new Item(new Item.Properties().food(FoodValues.HAM).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> SMOKED_HAM = ITEMS.register("smoked_ham",
			() -> new Item(new Item.Properties().food(FoodValues.SMOKED_HAM).tab(FarmersDelight.ITEM_GROUP)));

	// Sweets
	public static final RegistryObject<Item> PIE_CRUST = ITEMS.register("pie_crust",
			() -> new Item(new Item.Properties().food(FoodValues.PIE_CRUST).tab(FarmersDelight.ITEM_GROUP)));
	...
	public static final RegistryObject<Item> CAKE_SLICE = ITEMS.register("cake_slice",
			() -> new Item(new Item.Properties().food(FoodValues.CAKE_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> APPLE_PIE_SLICE = ITEMS.register("apple_pie_slice",
			() -> new Item(new Item.Properties().food(FoodValues.PIE_SLICE).tab(FarmersDelight.ITEM_GROUP)));
	...
	public static final RegistryObject<Item> SWEET_BERRY_COOKIE = ITEMS.register("sweet_berry_cookie",
			() -> new Item(new Item.Properties().food(FoodValues.COOKIES).tab(FarmersDelight.ITEM_GROUP)));
	...
	public static final RegistryObject<Item> MELON_POPSICLE = ITEMS.register("melon_popsicle",
			() -> new PopsicleItem(new Item.Properties().food(FoodValues.POPSICLE).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> FRUIT_SALAD = ITEMS.register("fruit_salad",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.FRUIT_SALAD).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));

	// Basic Meals
	public static final RegistryObject<Item> MIXED_SALAD = ITEMS.register("mixed_salad",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.MIXED_SALAD).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> NETHER_SALAD = ITEMS.register("nether_salad",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.NETHER_SALAD).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> BARBECUE_STICK = ITEMS.register("barbecue_stick",
			() -> new Item(new Item.Properties().food(FoodValues.BARBECUE_STICK).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> EGG_SANDWICH = ITEMS.register("egg_sandwich",
			() -> new Item(new Item.Properties().food(FoodValues.EGG_SANDWICH).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> CHICKEN_SANDWICH = ITEMS.register("chicken_sandwich",
			() -> new Item(new Item.Properties().food(FoodValues.CHICKEN_SANDWICH).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> HAMBURGER = ITEMS.register("hamburger",
			() -> new Item(new Item.Properties().food(FoodValues.HAMBURGER).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> BACON_SANDWICH = ITEMS.register("bacon_sandwich",
			() -> new Item(new Item.Properties().food(FoodValues.BACON_SANDWICH).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> MUTTON_WRAP = ITEMS.register("mutton_wrap",
			() -> new Item(new Item.Properties().food(FoodValues.MUTTON_WRAP).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> DUMPLINGS = ITEMS.register("dumplings",
			() -> new Item(new Item.Properties().food(FoodValues.DUMPLINGS).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> STUFFED_POTATO = ITEMS.register("stuffed_potato",
			() -> new Item(new Item.Properties().food(FoodValues.STUFFED_POTATO).tab(FarmersDelight.ITEM_GROUP)));
	public static final RegistryObject<Item> CABBAGE_ROLLS = ITEMS.register("cabbage_rolls",
			() -> new Item(new Item.Properties().food(FoodValues.CABBAGE_ROLLS).tab(FarmersDelight.ITEM_GROUP)));

	// Soups and Stews
	public static final RegistryObject<Item> COOKED_RICE = ITEMS.register("cooked_rice",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.COOKED_RICE).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> BEEF_STEW = ITEMS.register("beef_stew",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.BEEF_STEW).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> CHICKEN_SOUP = ITEMS.register("chicken_soup",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.CHICKEN_SOUP).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> VEGETABLE_SOUP = ITEMS.register("vegetable_soup",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.VEGETABLE_SOUP).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> FISH_STEW = ITEMS.register("fish_stew",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.FISH_STEW).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> FRIED_RICE = ITEMS.register("fried_rice",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.FRIED_RICE).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> PUMPKIN_SOUP = ITEMS.register("pumpkin_soup",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.PUMPKIN_SOUP).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> BAKED_COD_STEW = ITEMS.register("baked_cod_stew",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.BAKED_COD_STEW).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> NOODLE_SOUP = ITEMS.register("noodle_soup",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.NOODLE_SOUP).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));

	// Plated Meals
	public static final RegistryObject<Item> BACON_AND_EGGS = ITEMS.register("bacon_and_eggs",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.BACON_AND_EGGS).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> PASTA_WITH_MEATBALLS = ITEMS.register("pasta_with_meatballs",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.PASTA_WITH_MEATBALLS).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> PASTA_WITH_MUTTON_CHOP = ITEMS.register("pasta_with_mutton_chop",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.PASTA_WITH_MUTTON_CHOP).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> ROASTED_MUTTON_CHOPS = ITEMS.register("roasted_mutton_chops",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.ROASTED_MUTTON_CHOPS).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> VEGETABLE_NOODLES = ITEMS.register("vegetable_noodles",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.VEGETABLE_NOODLES).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> STEAK_AND_POTATOES = ITEMS.register("steak_and_potatoes",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.STEAK_AND_POTATOES).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> RATATOUILLE = ITEMS.register("ratatouille",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.RATATOUILLE).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> SQUID_INK_PASTA = ITEMS.register("squid_ink_pasta",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.SQUID_INK_PASTA).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	public static final RegistryObject<Item> GRILLED_SALMON = ITEMS.register("grilled_salmon",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.GRILLED_SALMON).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));
	...
	public static final RegistryObject<Item> ROAST_CHICKEN = ITEMS.register("roast_chicken",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.ROAST_CHICKEN).stacksTo(16).craftRemainder(Items.BOWL).tab(FarmersDelight.ITEM_GROUP), true));
	...
	public static final RegistryObject<Item> STUFFED_PUMPKIN = ITEMS.register("stuffed_pumpkin",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.STUFFED_PUMPKIN).stacksTo(16).craftRemainder(Items.BOWL).tab(FarmersDelight.ITEM_GROUP), true));
	...
	public static final RegistryObject<Item> HONEY_GLAZED_HAM = ITEMS.register("honey_glazed_ham",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.HONEY_GLAZED_HAM).stacksTo(16).craftRemainder(Items.BOWL).tab(FarmersDelight.ITEM_GROUP), true));
	...
	public static final RegistryObject<Item> SHEPHERDS_PIE = ITEMS.register("shepherds_pie",
			() -> new ConsumableItem(new Item.Properties().food(FoodValues.SHEPHERDS_PIE).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP), true));

	// Pet Foods
	public static final RegistryObject<Item> DOG_FOOD = ITEMS.register("dog_food",
			() -> new DogFoodItem(new Item.Properties().food(FoodValues.DOG_FOOD).craftRemainder(Items.BOWL).stacksTo(16).tab(FarmersDelight.ITEM_GROUP)));
